...
2. Use `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run render_page.py <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run pagespeed_check.py URL --json

# SPA-aware HTML/render inspection
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run render_page.py URL --mode auto --json
...
```bash
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run pagespeed_check.py URL --json
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run crux_history.py URL --json
```
