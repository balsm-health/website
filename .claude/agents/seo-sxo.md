...
- Fetch the target URL using `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run parse_html.py --url "<url>"` to extract SEO elements
