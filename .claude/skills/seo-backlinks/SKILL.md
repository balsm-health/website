...
2. **Moz API** (free signup): `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run backlinks_auth.py --check moz --json`
3. **Bing Webmaster** (free signup): `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run backlinks_auth.py --check bing --json`
...
Run `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run backlinks_auth.py --check --json` to detect all sources at once.
...
**Moz API:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run moz_api.py metrics <url> --json` → Domain Authority, Page Authority, Spam Score, linking root domains, external links.

**Common Crawl:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run commoncrawl_graph.py <domain> --json` → PageRank, harmonic centrality, and low-confidence rank/presence data.
...
**Moz API:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run moz_api.py anchors <url> --json`

**Bing Webmaster:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run bing_webmaster.py links <url> --json` (extract anchor text from link details)
...
**Moz API:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run moz_api.py domains <url> --json` → domains with DA scores

**Common Crawl:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run commoncrawl_graph.py <domain> --json` → domain-level rank/presence data, no verified referring-domain counts
...
**Moz API:** Raw vendor spam_score from `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run moz_api.py metrics <url> --json` (source-label the value; apply thresholds only if verified against current Moz docs)

**Verification Crawler:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run verify_backlinks.py --target <url> --links <file> --json` (verify suspicious links still exist)
...
**Moz API:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run moz_api.py pages <domain> --json`
...
**Bing Webmaster:** `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run bing_webmaster.py compare <url1> <url2> --json`
...
**Moz API:** Compare DA/PA between domains via `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run moz_api.py metrics <url> --json` for each
...
**Verification Crawler:** For known links, verify current status with `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run verify_backlinks.py --target <url> --links <file> --json`
