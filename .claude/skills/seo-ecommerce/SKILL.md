...
```
1. "/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run render_page.py <url> --mode auto → raw/rendered HTML
2. "/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run parse_html.py --url <url>   → SEO elements
...
```bash
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py check merchant_google_products_search
```
...
After each call:
```bash
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py log merchant_google_products_search <cost>
```
...
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_merchant.py search "<keyword>" --marketplace google

# Seller analysis: merchant ratings and dominance
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_merchant.py sellers "<keyword>"

# Normalize results for analysis
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_normalize.py results.json --module merchant
```
...
```bash
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py check merchant_amazon_products_search
```
...
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_merchant.py search "<keyword>" --marketplace amazon

# Cross-marketplace comparison
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_merchant.py compare "<keyword>"
```
...
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run ucp_check.py https://store.example.com --json

# With endpoint reachability probes (HEAD each declared capability)
"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run ucp_check.py https://store.example.com --probe-endpoints --json
```
