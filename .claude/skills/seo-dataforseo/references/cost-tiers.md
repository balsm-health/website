...
Configure with: `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py config --mode threshold --threshold 0.50 --daily-limit 10.00`
...
1. Run `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py check <endpoint> [--count N]`
...
5. After call completes, log: `"/Volumes/Dev/Balsm/website/.claude/skills/seo/bin/claude-seo" run dataforseo_costs.py log <endpoint> <cost>`
